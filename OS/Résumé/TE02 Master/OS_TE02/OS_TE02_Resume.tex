...
\insertImage{Img/1.PNG}{0.6}{Problèmes avec la RAM}{myImg}
\insertImage{Img/2.PNG}{0.6}{Exigences pour un stockage à long terme}{myImg}
...
\subsection{New Abstraction: the File}%DONEDONEDONEDONEDONEDONE
...
\subsubsection{File Name}                                                %DONEDONEDONEDONEDONEDONE
...
\subsubsection{File system Examples}                                                %DONEDONEDONEDONEDONEDONE
\insertImage{Img/5.PNG}{0.6}{File systems examples}{myImg}

\subsubsection{File extensions}
\insertImage{Img/4.PNG}{0.6}{Most common extensions}{myImg}
...
\subsubsection{File type}%DONEDONEDONEDONEDONEDONE
\insertImage{Img/6.PNG}{0.6}{FileName}{myImg}
\insertImage{Img/7.PNG}{0.6}{FileName}{myImg}
\insertImage{Img/8.PNG}{0.6}{FileName}{myImg}
\insertImage{Img/9.PNG}{0.6}{FileName}{myImg}
...
\subsection{File Operations}%DONEDONEDONEDONEDONEDONE
\begin{itemize}
...
\insertImage{Img/3.PNG}{0.6}{A simple program to copy a file}{myImg}

\subsection{File attributes}%DONEDONEDONEDONEDONEDONE
...
\insertImage{Img/10.PNG}{0.6}{Non exhaustive list of file attributes}{myImg}
...
\insertImage{Img/11.PNG}{0.6}{A single-level directory system containing four files.}{myImg}
...
\insertImage{Img/12.PNG}{0.6}{A hierarchical directory system.}{myImg}

\subsection{PathName}

\insertImage{Img/13.PNG}{0.6}{Les chemins d’accès(pathnames)}{myImg}
\insertImage{Img/14.PNG}{0.6}{Les chemins d’accès(pathnames)}{myImg}
...
\insertImage{Img/15.PNG}{0.6}{(a) Contiguous allocation of disk space for seven files. (b) The state of the disk after files D and F have been removed.}{frag}
