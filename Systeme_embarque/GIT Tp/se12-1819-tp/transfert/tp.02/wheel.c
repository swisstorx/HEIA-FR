...
static const enum wheel_direction transitions[4][4] = { 
	{ WHEEL_STILL,WHEEL_STILL, WHEEL_STILL, WHEEL_STILL },	//state 00 0
	{ WHEEL_LEFT, WHEEL_STILL, WHEEL_STILL, WHEEL_RIGHT },	//state 01 1
	{ WHEEL_RIGHT, WHEEL_STILL, WHEEL_STILL, WHEEL_LEFT }, 	//state 10 2
	{ WHEEL_STILL, WHEEL_STILL, WHEEL_STILL, WHEEL_STILL} 	//state 11 3
};
void wheel_init() {
